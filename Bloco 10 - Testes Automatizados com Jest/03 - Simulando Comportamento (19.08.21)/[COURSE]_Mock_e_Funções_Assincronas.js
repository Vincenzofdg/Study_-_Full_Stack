...
/* O retorno da API são 200 posições no formato:
[
  {
...
// Agora iremos mockar a requesição e fazer dois teste:
...
// Caso queira simular os efeitos colaterais da API, você pode definir o retorno como um objeto JSON.
const api = require("./api");
